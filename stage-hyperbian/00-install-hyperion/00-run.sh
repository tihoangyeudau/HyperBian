...
HYPERION_DOWNLOAD_URL="https://github.com/tihoangyeudau/hyperion.ng-1/releases/download"
HYPERION_RELEASES_URL="https://api.github.com/repos/tihoangyeudau/hyperion.ng-1/releases"
